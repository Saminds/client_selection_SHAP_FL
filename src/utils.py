...
def get_dataset(args):
    ...
    if args.dataset == 'OurMNIST' and args.trueshapley == '' and args.num_users == 5:
        data_dir = 'Shapley-Algorithms-Federated-Learning--toefinde/data/OurMNIST/'
        #Shapley-Algorithms-Federated-Learning--toefinde\data\OurMNIST
        ...
        print(" this is the path of your data thanks me later: ", data_dir + 'dictionary'+traindivision_index[0]+'.out', "\n")
